...
//            handicapStatus = selectedButton.getText().toString();
//
//
//            // 아이디 중복확인
//            if (!isIdChecked) {
...
//            }
    ...
    private void sendRegistrationDataToServer(String USER_ID, String PASSWORD, String USERNAME, String USERBIRTH, String handicapStatus) {
    ...
    private void checkIdAvailability() {
        ...
        new Thread(() -> {
            try {
                ...
                URL url = new URL("https://ec2-3-38-63-26.ap-northeast-2.compute.amazonaws.com:80/createUser/register"); // 실제 서버 URL로 변경
